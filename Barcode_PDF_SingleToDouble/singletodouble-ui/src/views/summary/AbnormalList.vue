  ...
  <div class="app-container"> 
    <el-row :gutter="10" class="mb8">
      <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" >      
        ...
        <el-form-item label="处置人：" prop="confirmUserQr">
          <el-select v-model="queryParams.confirmUserQr"">
            <el-option v-for="item in userList" :key="item.userQr" :label="item.userName" :value="item.userQr"/>            
          </el-select>
        </el-form-item>
    ...
    <el-table
      ...
      row-key="id"
    >    
      <el-table-column prop="lineName" label="流水线" header-align="center" align="center" width="200"></el-table-column>
      ...
      <el-table-column prop="labelId" label="布标ID/刻印号" header-align="center" align="center" width="150"></el-table-column>
      <el-table-column prop="handleText" label="处置内容" header-align="center" align="center"></el-table-column>
      <el-table-column prop="confirmUserName" label="异常处置人员" header-align="center" align="center" width="150"></el-table-column>
      <el-table-column label="处置时间" align="center" width="200">
...
<script>
import { listAbnormal } from "@/api/summary/index";
import { listPipeline, listAbnormalUser } from "@/api/system/base";
...
export default {
  ...
  methods: {
    ...
    getUserList() {
      listAbnormalUser({}).then(response => {
        this.userList.push({
          userQr:"",
          userName:"所有"
        });
    ...
    getList() {
      this.loading = true;
      listAbnormal(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('/summary/abnormalhandle/export', {
        ...this.queryParams
      }, `异常处置历史(${this.dateRange[0]}~${this.dateRange[1]}).xlsx`)
    }
  }
};
</script>
